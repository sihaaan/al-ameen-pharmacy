            ...
            <div className="modal-info-section">
              ...
              <div className="modal-header">
                ...
                {product.manufacturer && (
                  <p className="modal-manufacturer">by {product.manufacturer}</p>
                )}
              </div>
              ...
              <div className="modal-price-section">
                <div className="modal-price-row">
                  <span className="modal-price">AED {parseFloat(product.price).toFixed(2)}</span>
                  {product.stock_quantity > 0 ? (
                    ...
                    <span className="modal-stock out-of-stock">Out of Stock</span>
                  )}
                </div>
              </div>
              ...
              <div className="modal-actions">
                <button
                  className={`modal-add-to-cart ${addedSuccess ? "success" : ""}`}
