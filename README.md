...
### Admin
- **Quotation Module** - Staff-only quotation workflow in `Admin Dashboard -> Quotations` for companies, quote items, manual/imported inquiries, price history, finalization, and protected PDFs
