# Generated by Django 5.2.6 on 2026-04-09 21:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(blank=True, max_length=220, unique=True)),
                ('short_description', models.TextField(help_text='Brief description shown in product cards/grid')),
                ('detailed_description', models.TextField(blank=True, help_text='Full description with usage, dosage, warnings, etc.')),
